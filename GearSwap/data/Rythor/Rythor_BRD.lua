...
function user_setup()
	...
	-- need a better way of being able to modify this through the game.
	info.ExtraSongSpell = 'Valor Minuet IV' 
...
function get_song_class(spell)
	...
	elseif state.ExtraSongSpell.current == 'on' and spell.english == info.ExtraSongSpell then
		return 'DaurdablaDummy'
    else
        return 'SongEffect'
    end
